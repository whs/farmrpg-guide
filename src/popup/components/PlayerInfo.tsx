...
export default class PlayerInfo extends Component<Props, {}> {
	render() {
		...
		return (
			<div class="bg-slate-300 m-3 rounded-md border-1 border-slate-800 p-2 text-xs group">
				<div class="mb-1">
					<span class="font-bold inline mr-1">Player Info</span>
					<span class="text-slate-800 inline group-hover:hidden">Hover to view</span>
					<span class="text-slate-800 hidden group-hover:inline">Hover over item for updating guide</span>
				</div>
